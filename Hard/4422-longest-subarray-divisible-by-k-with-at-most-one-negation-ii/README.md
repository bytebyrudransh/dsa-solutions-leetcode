# [LeetCode] Longest Subarray Divisible by K with At Most One Negation II

**Difficulty:** Hard  
**Language:** Python3  
**Runtime:** 3197 ms  
**Memory:** 31.2 MB  
**Link:** [Problem Link](https://leetcode.com/problems/longest-subarray-divisible-by-k-with-at-most-one-negation-ii/)
