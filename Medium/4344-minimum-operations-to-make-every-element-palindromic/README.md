# [LeetCode] Minimum Operations to Make Every Element Palindromic

**Difficulty:** Medium  
**Language:** Python3  
**Runtime:** 542 ms  
**Memory:** 43.9 MB  
**Link:** [Problem Link](https://leetcode.com/problems/minimum-operations-to-make-every-element-palindromic/)
